...
public class ClasseConexao
{
    ...
    private SqlConnection conectar()
    {
        ...
        {
            string db = "testeChat";
			String strConexao = "Password=16m0g$06; Persist Security Info=True; User ID=sa; Initial Catalog=" + db + "; Data Source=" + Environment.MachineName;
			//String strConexao = "Password=etesp; Persist Security Info=True; User ID=sa; Initial Catalog=" + db + "; Data Source=" + Environment.MachineName + @"\SQLEXPRESS";
			//String strConexao = "Password=aluno; Persist Security Info=True; User ID=sa; Initial Catalog=" + db + "; Data Source=" + Environment.MachineName;
			//String strConexao = "Password=etesp; Persist Security Info=True; User ID=aluno; Initial Catalog=" + db + "; Data Source=" + Environment.MachineName;
    ...
    public DataTable executa_Procedure(String x, List<List<string>> parameters)
    {
        ...
        {
            conectar();
            cmd = new SqlCommand(x, conectar()); //não digitar Exec, não passar os parâmetros

			foreach (List<string> r in parameters)
			{
				cmd.Parameters.Add(new SqlParameter(r[0], r[0])); 
			}
